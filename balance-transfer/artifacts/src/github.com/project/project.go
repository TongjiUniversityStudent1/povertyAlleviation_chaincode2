...
var logger = shim.NewLogger("project")
...
type DraftStruct struct {
	...
	DraftMount string  `json:"DraftMount"`
}

//资金进度结构体
type FundStruct struct {
	Priority1 DraftStruct  `json:"DraftStruct"`
	Priority2 DraftStruct  `json:"DraftStruct"`
	Priority3 DraftStruct  `json:"DraftStruct"`
}

type Project struct{
	ProjectHash  string 		 `json:"ProjectHash"`
	Approval     ApprovalStruct  `json:"ApprovalStruct"`
	Draft        DraftStruct	 `json:"DraftStruct"`
	Fund         FundStruct      `json:"FundStruct"`
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {
	...
	}else if function == "updateApproval" {
...
func (t *SimpleChaincode) addProject(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {
	...
	err = stub.PutState(ProjectID, []byte(Project))
	if err != nil {
		return shim.Error("This ID already ProjectID")
	}
...
func (t *SimpleChaincode) updateApproval(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) updateProject(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) updateProjectProgress(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) updateFundProgress(stub shim.ChaincodeStubInterface, args []string) pb.Response {
